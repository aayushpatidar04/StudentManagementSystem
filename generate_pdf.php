...
{   
    if($fields[$heading['Field']]=='image'||$fields[$heading['Field']]=='Image'||$fields[$heading['Field']]=='state'||$fields[$heading['Field']]=='State'){
        $pdf->Cell(30,12,$fields[$heading['Field']],1);
    }
    else{
...
foreach($result as $row) 
{
    ...
    {
        $sql="SELECT MAX(state) FROM student";
