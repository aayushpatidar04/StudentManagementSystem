        ...
        <div class="container">
            ...
            if(mysqli_num_rows($res)>0){
                ...
                while($row = mysqli_fetch_array($res)){
                    ...
                    echo "<td>" . $row['role'] . "</td>";
                    echo "<td>";	
                        echo '<a href="read.php?id='. $row['id'] .'" class="mr-3 btn btn-secondary" title="Open Details" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                        echo '<a href="update.php?id='. $row['id'] .'" class="mr-3 btn btn-secondary" title="Update Details" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
