                    ...
                    if(mysqli_num_rows($res)>0){
                        ...
                        while($row = mysqli_fetch_array($res)){
                            echo "<tr>";
                                ...
                                echo '<option value="student"><a href="javascript:void(0)" title="Change Status" class="student_btn_ajax" data-toggle="tooltip">Student</a><input type="hidden" class="student_id_value" value="'.$row["id"].'"></option>';
                                echo '<option value="admission"><a href="javascript:void(0)" title="Change Status" class="admission_btn_ajax" data-toggle="tooltip">Admission</a><input type="hidden" class="admission_id_value" value="'.$row["id"].'"></option>';
                                echo '<option value="teacher"><a href="javascript:void(0)" title="Change Status" class="teacher_btn_ajax" data-toggle="tooltip">Teacher</a><input type="hidden" class="teacher_id_value" value="'.$row["id"].'"></option>';
                                echo '</select>';
                                ...
                                // echo '<a href="javascript:void(0)" title="Change Status" class="dropdown-item student_btn_ajax" data-toggle="tooltip">Student</a>';
                                // echo '<input type="hidden" class="student_id_value" value="'.$row["id"].'">';
                                // echo '<a href="javascript:void(0)" title="Change Status" class="dropdown-item admission_btn_ajax" data-toggle="tooltip">Admission</a>';
                                // echo '<input type="hidden" class="admission_id_value" value="'.$row["id"].'">';
                                // echo '<a href="javascript:void(0)" title="Change Status" class="dropdown-item teacher_btn_ajax" data-toggle="tooltip">Teacher</a>';
