        ...
        <div class="container">
            ...
            if(mysqli_num_rows($res)>0){
                ...
                while($row = mysqli_fetch_array($res)){
                    ...
                    echo "<td>" . $row['role'] . "</td>";
                    echo "<td>";	
                        echo '<a href="readteacher.php?id='. $row['id'] .'" class="mr-3 btn btn-info" title="Open Details" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                        echo '<a href="updateteacher.php?id='. $row['id'] .'" class="mr-3 btn btn-info" title="Update Details" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
