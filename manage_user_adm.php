                    ...
                    if(mysqli_num_rows($res)>0){
                        ...
                        while($row = mysqli_fetch_array($res)){
                            echo "<tr>";
						        ...
						        echo "<td>" . $row['role'] . "</td>";
                                echo "<td>";
        						echo '<a href="read_admission.php?id='. $row['id'] .'" class="mr-3 btn btn-secondary" title="View Details" data-toggle="tooltip"><span class="fa fa-eye"></span></a></td>';
                                echo "<td>";
        						echo '<a href="update_admission.php?id='. $row['id'] .'" class="mr-3 btn btn-secondary" title="Update Details" data-toggle="tooltip"><span class="fa fa-pencil"></span></a></td>';
                                echo "<td>";
